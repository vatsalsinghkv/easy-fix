...
const SortBy: React.FC<Props> = ({
  ...
  return (
    <div>
      <div
        className={`cursor-pointer flex p-3 py-1.5 font-mono text-xs capitalize transition-all border rounded hover:text-accent hover:border-accent focus-visible:text-accent focus-visible:border-accent border-slate-400 relative group ${
